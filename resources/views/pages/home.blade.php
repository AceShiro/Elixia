            ...
            <ul class="timeline">
              ...
              <li class="timeline-inverted">
                <div class="timeline-image-last">
                  <img class="rounded-circle img-fluid" src="{{ asset('img/logoElixiaSansFondReduit.png') }}" alt="">
                </div>
              </li>
            </ul>
          </div>
...
@section('modals')
  @foreach($events as $event)
    <div class="patern2-modal modal fade" id="{{ 'event' . $event->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-lg-6">
                        ...
                        <img class="img-fluid d-block mx-auto" src="thumbnails/{{$event->id}}.jpg" alt="" style="box-shadow: 5px 10px 5px #888;">
                    ...
                    <div class="col-lg-6">
                      <div class="row justify-content-center">
                        <div class="col-md-11" >
                          <h2>{{ $event->name }}</h2>
                          <p class="item-intro events">Catégorie : {{ $event->type }}</p>
                          <hr>
                          <p class="text-justify events">{{ $event->description }}</p>
                          <hr>
                          ...
                          @if($event->availability > 0)
                            @if (Auth::guest())
                              <a href="{{ route('login') }}" class="btn btn-info"><i class="fa fa-sign-in"></i> Se connecter</a>
                            @elseif (Auth::user()->events()->Find($event->id))
                              <!-- Le vide... -->
                            @else
                              <a href="{{ route('events.show', $event->id) }}" class="btn btn-success"><i class="fa fa-sign-in"></i> S'inscrire</a>
                            @endif
                          ...
                          @elseif(Auth::user()->admin == true)
                            <a href="{{ route('events.show', $event->id) }}" class="btn btn-info"><i class="fa fa-sign-in"></i> Voir</a>
                          @endif
          ...
          <div class="container tarifs">
            <div class="row">
              <div class="col-lg-10 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <img class="tarif-logo" src="{{ asset('img/logoElixiaSansFondReduit.png') }}" alt="">
