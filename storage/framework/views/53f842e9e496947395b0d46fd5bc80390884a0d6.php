    	...
    	<div class="row">
    		<div class="col-md-4">
	          ...
	          <div class="box box-danger">
	            ...
	            <!-- /.box-header -->
	            <form class="form-horizontal" method="POST" action="<?php echo e(route('reservation.store', $event->id)); ?>">
                	<?php echo csrf_field(); ?>
	            <div class="box-body">
                  <div class="form-group">
                    <div class="col-sm-offset-1 col-sm-10">
                      <div class="radio">
                        <label for="payment">
                        	<input checked type="radio" id="payment" name="payment" value="1"><?php echo e(__(" Je possede un abonnement")); ?>

                        	<hr>
                        	<input type="radio" id="payment" name="payment" value="0"><?php echo e(__("Entree individuelle a payer sur place")); ?>
